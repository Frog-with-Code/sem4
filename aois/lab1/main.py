...
def main():
    ...
    print("\nЗАДАНИЕ 1: Сложение/вычитание в разных кодах")
    ...
    print(f"Результат: {fp_result['sign_bit']} 0.{fp_result['mantissa_sum']} × 2^{fp_result['result_order']} = {fp_result['result_value']}₁₀")
